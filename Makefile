# This Makefile is for the HTML::TextArrayGenerator extension to perl.
#
...
#     ABSTRACT_FROM => q[TextArrayGenerator.pm]
#     AUTHOR => q[kot <kot@localdomain>]
#     NAME => q[HTML::TextArrayGenerator]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[TextArrayGenerator.pm]
...
AR_STATIC_ARGS = cr
NAME = HTML::TextArrayGenerator
DISTNAME = HTML-TextArrayGenerator
NAME_SYM = HTML_TextArrayGenerator
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
...
FULLEXT = HTML/TextArrayGenerator
BASEEXT = TextArrayGenerator
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = TextArrayGenerator.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = TextArrayGenerator.pm
...
TO_INST_PM = TextArrayGenerator.pm

PM_TO_BLIB = TextArrayGenerator.pm \
	blib/lib/HTML/TextArrayGenerator.pm
...
manifypods : pure_all TextArrayGenerator.pm
	@$(POD2MAN) \
	TextArrayGenerator.pm \
	$(INST_MAN3DIR)/HTML::TextArrayGenerator.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/HTML/TextArrayGenerator.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,01,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Easy generation of a HTML array</ABSTRACT>\n\t<AUTHOR>kot &lt;kot\@localdomain&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{TextArrayGenerator.pm blib/lib/HTML/TextArrayGenerator.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
